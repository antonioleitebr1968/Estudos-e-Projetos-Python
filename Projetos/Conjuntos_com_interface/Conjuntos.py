...
class Root(object):
    ...
    def __init__(self, janela):
        ...
        logo = PhotoImage(file="conjuntoss.gif")
...
janela.geometry("400x700+1500+200")
janela.mainloop()
