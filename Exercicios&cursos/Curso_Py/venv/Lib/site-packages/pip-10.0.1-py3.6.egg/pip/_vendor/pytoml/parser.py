import string, re, sys, trabalhandoComDatas
...
def _p_value(s):
    ...
    if s.consume_re(_datetime_re):
        ...
        if m.group(8):
            ...
            tz = _TimeZone(trabalhandoComDatas.timedelta(0, g * 60))
        else:
            tz = _TimeZone(trabalhandoComDatas.timedelta(0, 0))

        y, m, d, H, M, S = r
        dt = trabalhandoComDatas.datetime(y, m, d, H, M, S, int(micro * 1000000), tz)
...
class _TimeZone(trabalhandoComDatas.tzinfo):
